...
def _league_tables(sports, matchup, league_box_scores, descriptions):
    data_by_team, categories_info = utils.active_stats.stats_by_team(matchup, league_box_scores, sports)
...
def calculate_tables(group_settings, matchup, league_names, box_scores, descriptions):
    ...
    for league_id in group_settings['leagues']:
        ...
        tables = _league_tables(sports, matchup, league_box_scores, descriptions)
